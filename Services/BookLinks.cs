...
namespace Services
{
    public class BookLinks : IBookLinks
    {
        ...
        public BookLinks(LinkGenerator linkGnerator,IDataShaper<BookDto> dataShaper)
        {
            _linkGenerator = linkGnerator;
            _datashaper = dataShaper;
        }
        public LinkResponse TryGnerateLinks(IEnumerable<BookDto> booksDto, string fields, HttpContext httpContext)
        {
